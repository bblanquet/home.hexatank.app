...
import { BlueGameHook } from '../Hooks/BlueGameHook';
import TopButtons from '../Components/TopButtons';

export default class BlueGameScreen extends HookedComponent<{}, BlueGameHook, RuntimeState> {
	public GetDefaultHook(): BlueGameHook {
		return new BlueGameHook(SingletonKey.Gameworld, useState(BlueGameHook.DefaultState()));
	}

...
export class BasicInfluenceField extends Item{
    ...
    constructor(public InfluenceField:InfluenceField){
        ...
        this.GetDisplayObjects().forEach(obj => {obj.visible = this.InfluenceField.GetCell().IsVisible();});
    ...
    public Update(viewX: number, viewY: number):void{
        ...
        this.SetBothProperty(this.InfluenceField.Hq.GetSkin().GetEnergy(),s=>s.rotation += 0.01*(this.InfluenceField.GetPower()));

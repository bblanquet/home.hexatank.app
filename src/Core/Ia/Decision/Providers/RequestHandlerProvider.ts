...
export class RequestHandlerProvider implements IRequestHandlerProvider {
	constructor(private _hq: Headquarter, private _kindgom: Kingdom, private _context: GameContext) {}
	...
	Get(): Groups<ISimpleRequestHandler> {
		...
		handlers.Add(RequestPriority.High, new SquadRequestHandler(this._context, this._kindgom));
		...
		handlers.Add(RequestPriority.High, new HealUnitRequestHandler(this._kindgom));
		handlers.Add(RequestPriority.High, new HealingRequestHandler(this._hq));
		handlers.Add(RequestPriority.High, new TruckRequestHandler(this._hq, this._kindgom));
		handlers.Add(
			RequestPriority.High,
			new TankHighRequestHandler(this._kindgom, new TankMediumRequestHandler(this._kindgom, this._hq))
		);
		handlers.Add(RequestPriority.Medium, new TankMediumRequestHandler(this._kindgom, this._hq));
		handlers.Add(RequestPriority.Low, new TankMediumRequestHandler(this._kindgom, this._hq));

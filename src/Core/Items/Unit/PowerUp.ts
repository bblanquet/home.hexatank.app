...
export class PowerUp extends Item {
	...
	constructor(private _tank: Tank) {
		...
		this._sleepTimer = new TickTimer(5);
	...
	public SetActive(isActive: boolean): void {
		...
		if (!isActive) {
			...
			this._activeTimer = new TimeTimer(20000);
			this._animatorAnimator = new BouncingScaleUpAnimator(this, Archive.powerUpR);
		}
	}
